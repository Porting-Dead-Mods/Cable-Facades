...
public record FacadeData(@NotNull Identifier facadeType,
    ...
    public static FacadeData fullBlock(Identifier type, BlockState state) {
    ...
    public static FacadeData directional(Identifier type, Direction face, BlockState state) {
        EnumMap<Direction, BlockState> map = new EnumMap<>(Direction.class);
        map.put(face, state);
    ...
    public static FacadeData directional(Identifier type, EnumMap<Direction, BlockState> faces) {
    ...
    private static final MapCodec<FacadeData> FULL_CODEC = RecordCodecBuilder.mapCodec(builder -> builder.group(
            Identifier.CODEC.optionalFieldOf("facadeType", FacadeTypes.DEFAULT_ID).forGetter(FacadeData::facadeType),
    ...
    public static final StreamCodec<ByteBuf, FacadeData> STREAM_CODEC = new StreamCodec<>() {
        ...
        public FacadeData decode(ByteBuf buf) {
            Identifier facadeType = Identifier.parse(ByteBufCodecs.STRING_UTF8.decode(buf));
