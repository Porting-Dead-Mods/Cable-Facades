...
public class FacadeUtils {
    ...
    public static void addFacade(Level level, BlockPos pos, BlockState blockState, Identifier facadeType) {
        if (level instanceof ServerLevel serverLevel) {
            FacadeData data = FacadeData.fullBlock(facadeType, blockState);
            CableFacadeSavedData.get(serverLevel).addFacade(pos, data);
            PacketDistributor.sendToPlayersTrackingChunk(serverLevel, ChunkPos.containing(pos), new AddFacadePayload(pos, data));
        }
    }
    ...
    public static void addDirectionalFacade(Level level, BlockPos pos, Direction face, BlockState blockState, Identifier facadeType) {
        if (level instanceof ServerLevel serverLevel) {
    ...
    public static void updateBlocks(Level level, BlockPos pos) {
        ...
        if (!level.isClientSide()) {
            ...
            level.updateNeighborsAtExceptFromFacing(pos, state.getBlock(), null, null);
