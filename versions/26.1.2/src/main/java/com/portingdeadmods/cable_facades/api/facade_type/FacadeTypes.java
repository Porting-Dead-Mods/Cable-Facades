...
public final class FacadeTypes {
    ...
    public static final Identifier DEFAULT_ID = Identifier.fromNamespaceAndPath(CFMain.MODID, "facade");

    private static final Map<Identifier, FacadeType> REGISTRY = new ConcurrentHashMap<>();
    ...
    public static FacadeType get(Identifier id) {
    ...
    @Nullable
    public static FacadeItem fullItemFor(Identifier id) {
    ...
    @Nullable
    public static DirectionalFacadeItem directionalItemFor(Identifier id) {
        FacadeType type = get(id);
