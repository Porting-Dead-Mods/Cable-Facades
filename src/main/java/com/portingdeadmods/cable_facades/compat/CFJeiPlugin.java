...
//                Identifier.fromNamespaceAndPath(CFMain.MODID, "facade_crafting"),
//                new ShapelessRecipe("facades", CraftingBookCategory.BUILDING, facadeResult,
//                        List.of(Ingredient.of(CFItems.FACADE.get())/*, Ingredient.of(ingredientStack)*/))
//        )));
...
//        registration.addRecipes(RecipeTypes.CRAFTING, Collections.singletonList(new RecipeHolder<>(
//                Identifier.fromNamespaceAndPath(CFMain.MODID, "directional_facade_crafting"),
//                new ShapelessRecipe("facades", CraftingBookCategory.BUILDING, directionalResult,
//                        List.of(Ingredient.of(CFItems.DIRECTIONAL_FACADE.get()), Ingredient.of(ingredientStack)))
//        )));
...
//        registration.addRecipes(RecipeTypes.CRAFTING, Collections.singletonList(new RecipeHolder<>(
//                Identifier.fromNamespaceAndPath(CFMain.MODID, "facade_to_directional"),
