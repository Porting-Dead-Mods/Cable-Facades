...
import com.portingdeadmods.cable_facades.client.renderer.item.FacadeIconDecorator;
...
public final class CFClientEvents {
    private static final FacadeIconDecorator DECORATOR = new FacadeIconDecorator();
